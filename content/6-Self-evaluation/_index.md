...
| --- | ------------------------------------------- | ------------------------------------------------------------------------------------------------ | --------- | ---- | ------- |
| 1   | **Professional knowledge and skills**       | Industry understanding, practical knowledge application, tool proficiency, work quality          | ☐         | ✅    | ☐       |
...
* I need to learn how to analyze problems from multiple perspectives, understand the root causes deeply to provide optimal and quick solutions.
* I need to improve my ability to present ideas and respond in meetings and workplace communication to ensure exchanges are always clear and effective.
* Although I have been proactive in learning, I need to further enhance my ability to find resources, approach new technologies, and apply them to work.
